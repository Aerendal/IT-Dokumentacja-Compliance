...
class TestMatchCatalogEntry:
    ...
    def test_exact_match_returns_exact_confidence(self):
        from scripts.gap_analysis import CONFIDENCE_EXACT, match_catalog_entry
    ...
    def test_high_confidence_similar_title(self):
        from scripts.gap_analysis import CONFIDENCE_EXACT, CONFIDENCE_HIGH, match_catalog_entry
    ...
    def test_mapping_boost_lowers_threshold(self):
        ...
        result = match_catalog_entry(
            "Incident Management Procedure", docs, mapped_docs={"core/mapped.md"}
        )
        assert result is not None
    ...
    def test_medium_confidence_partial_match(self):
        from scripts.gap_analysis import CONFIDENCE_MISS, match_catalog_entry
