...
def chain_db():
    ...
    conn.executescript("""
        ...
        CREATE TABLE sections (section_uid TEXT, doc_uid TEXT, heading_text TEXT, heading_norm TEXT,
            heading_level INTEGER, heading_path TEXT, anchor TEXT, ordinal INTEGER,
            status TEXT, text_fingerprint_sha256 TEXT, start_line INTEGER, end_line INTEGER);
        ...
        CREATE TABLE content_links_resolved (id INTEGER, content_link_id INTEGER, from_kind TEXT,
            from_uid TEXT, to_kind TEXT, to_uid TEXT, link_type TEXT, direction TEXT,
            rationale TEXT, strength TEXT, resolution_method TEXT, resolution_confidence REAL, notes TEXT);
        ...
        INSERT INTO flags VALUES (1, 'A', '1.0', 1, 0);
