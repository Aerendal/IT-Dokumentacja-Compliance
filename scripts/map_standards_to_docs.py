...
STANDARD_RULES: list[tuple[list[str], list[str]]] = [
    ...
    (["security", "bezpiecze", "isms", "access_control", "access control",
      "vulnerability", "penetration", "pentest", "threat", "risk",
      "incident", "forensic", "soc ", "siem", "dlp", "encryption",
      "cryptograph", "firewall", "iam", "identity", "authentication",
      "authorization", "zero_trust", "zero trust", "hardening"],
     ["ISO/IEC 27001", "ISO/IEC 27002", "ISO/IEC 27005", "CIS Controls v8", "NIST CSF"]),

    # API i aplikacje webowe
    (["api_security", "api security", "owasp", "web_security", "application_security",
      "secure_coding", "code_review_security", "xss", "sql_injection", "csrf"],
    ...
    # Chmura
    (["cloud", "chmura", "azure", "aws", "gcp", "kubernetes", "container",
      "serverless", "saas", "paas", "iaas"],
     ["ISO/IEC 27017", "ISO/IEC 27018", "SOC 2", "CIS Controls v8"]),

    # Prywatnosc i dane osobowe
    (["privacy", "prywatno", "gdpr", "rodo", "personal_data", "dane_osobowe",
      "pii", "dpia", "data_protection", "ochrona_danych", "consent", "anonymiz",
      "pseudonymiz"],
     ["GDPR / RODO", "ISO/IEC 27701", "ISO/IEC 27018"]),

    # Jakosc oprogramowania
    (["quality", "jakosc", "test", "qa", "defect", "bug", "verification",
      "validation", "acceptance", "review", "inspection", "metric", "kpi",
      "sla", "nfr", "non_functional", "performance", "load_test", "stress_test"],
     ["ISO/IEC 25010", "ISO 9001", "IEEE 829"]),

    # Wymagania
    (["requirement", "wymagani", "srs", "brd", "frs", "use_case", "user_story",
      "backlog", "specification"],
     ["IEEE 830", "ISO/IEC 12207", "ISO 9001"]),

    # Projekt / Design
    (["design", "architecture", "architektur", "sdd", "adr", "decision",
      "pattern", "uml", "diagram", "blueprint", "solution"],
     ["IEEE 1016", "IEEE 42010", "TOGAF ADM", "ISO/IEC 15288"]),

    # Zarzadzanie projektami
    (["project", "projekt", "gantt", "roadmap", "milestone", "sprint",
      "scrum", "agile", "kanban", "wbs", "charter", "kickoff", "retrospect",
      "standup", "planning"],
     ["PMBOK 7", "PRINCE2 7", "SCRUM Guide", "ISO/IEC 12207"]),

    # Zarzadzanie produktem
    (["product", "produkt", "vision", "wizja", "okr", "north_star",
      "go_to_market", "launch", "roadmap"],
     ["PMBOK 7", "SCRUM Guide"]),

    # ITSM / Operacje
    (["incident_management", "problem_management", "change_management",
      "service_desk", "helpdesk", "cmdb", "configuration_management",
      "release_management", "itsm", "servicedesk", "service_catalog",
      "sla", "escalation", "on_call"],
     ["ITIL 4", "ISO 20000-1"]),

    # Ciaglosc dzialania / DR
    (["business_continuity", "disaster_recovery", "bcp", "drp", "rto", "rpo",
      "backup", "failover", "restore", "recovery", "ciaglo", "bcm"],
     ["ISO 22301", "ISO/IEC 27001", "ITIL 4"]),

    # DevOps / CI-CD
    (["devops", "ci_cd", "cicd", "pipeline", "deployment", "release",
      "infrastructure_as_code", "iac", "terraform", "ansible", "gitops",
      "monitoring", "observability", "alerting", "sre", "reliability"],
     ["ISO/IEC 12207", "ITIL 4", "CIS Controls v8"]),

    # AI / ML
    (["machine_learning", "deep_learning", "ai_", "_ai", "mlops", "model",
      "neural", "llm", "nlp", "computer_vision", "dataset", "training",
      "inference", "bias", "fairness", "explainab", "ai_ethics"],
     ["ISO/IEC 42001", "ISO/IEC 23053", "NIST CSF"]),

    # Dane / Data Engineering
    (["data_governance", "data_quality", "data_catalog", "data_lineage",
      "data_warehouse", "data_lake", "etl", "elt", "pipeline_data",
      "master_data", "metadata", "big_data", "analytics", "bi_"],
     ["ISO/IEC 20546", "ISO 9001", "ISO/IEC 25010"]),

    # API (ogolnie)
    (["api_design", "api_documentation", "openapi", "swagger", "rest_api",
      "graphql", "grpc", "api_gateway", "api_versioning", "api_management"],
     ["OpenAPI 3.x", "ISO/IEC 27001", "ITIL 4"]),

    # Platnosci / Fintech
    (["payment", "platno", "pci", "card", "transaction", "billing",
      "fintech", "banking", "wallet", "checkout"],
     ["PCI DSS", "GDPR / RODO", "ISO/IEC 27001"]),

    # Zdrowie
    (["health", "medical", "clinical", "patient", "ehr", "fhir", "hl7",
      "telemedicine", "telemedycyn", "dicom", "hipaa"],
     ["HL7 FHIR", "ISO/IEC 27001", "GDPR / RODO"]),

    # Architektura korporacyjna / Lad IT
    (["enterprise_architecture", "ea_", "_ea_", "governance", "lad",
      "board", "audit", "compliance", "regulatory", "cobit"],
     ["COBIT 2019", "TOGAF ADM", "ISO/IEC 38500"]),

    # Dokumentacja techniczna
    (["technical_documentation", "system_documentation", "software_documentation",
      "dokumentacja_techniczna", "release_notes", "changelog", "wiki"],
     ["ISO/IEC 12207", "IEEE 829", "ISO 9001"]),

    # Scaled Agile / Enterprise Agile
    (["safe_", "agile_at_scale", "scaled_agile", "pi_planning", "art_",
...
REGULATION_RULES: list[tuple[list[str], list[str]]] = [
    ...
    (["security", "bezpiecze", "ksc", "csirt", "incident", "vulnerability",
      "penetration", "cybersecu", "nis2", "dora"],
     ["KSC-PL", "CERT-PL-WYTYCZNE"]),

    # Dane osobowe / RODO
    (["privacy", "prywatno", "gdpr", "rodo", "personal_data", "dane_osobowe",
      "dpia", "data_protection", "ochrona_danych", "consent", "anonymiz", "pii"],
     ["UODO-PL"]),

    # E-commerce / serwisy online
    (["e_commerce", "ecommerce", "web_service", "online_service", "portal",
      "sklep", "marketplace", "cookies", "regulamin"],
     ["UŚUDE-PL", "UODO-PL"]),

    # Finanse / fintech
    (["payment", "platno", "billing", "fintech", "banking", "financial",
      "finans", "trading", "investment", "portfolio_financial", "mifid",
      "kyc", "aml", "credit", "loan"],
    ...
    (["public_sector", "administrac", "government", "e_government",
      "public_procurement", "zamowien", "pzp", "epuap", "obywatel"],
     ["PZP-PL", "MC-INTEROP-PL", "CYBERSEC-STRATEGIA-PL"]),

    # Telekomunikacja
    (["telecom", "telekomunikac", "network", "5g", "lte", "uke",
      "carrier", "operator"],
     ["PT-PL", "UKE-WYTYCZNE", "KSC-PL"]),

    # Rachunkowosc / ERP
    (["accounting", "rachunko", "erp", "financial_reporting", "ledger",
      "invoice", "faktura", "ksiegowosc"],
     ["UoR-PL"]),

    # Podpis elektroniczny / KEP
    (["electronic_signature", "podpis_elektroniczny", "kep", "eidas",
      "qualified_signature", "timestamp", "certificate_management"],
     ["KEP-PL"]),

    # Standardy jakosci (normy PN)
    (["quality", "jakosc", "iso_9001", "qms", "iso_27001", "isms",
      "iso_20000", "itsm", "iso_25010", "squale"],
     ["PN-EN-ISO-9001", "PN-ISO/IEC-27001", "PN-EN-ISO-IEC-20000-1"]),

    # Ciaglosc dzialania
    (["business_continuity", "disaster_recovery", "bcp", "drp", "bcm"],
     ["PN-ISO-22301", "KSC-PL"]),

    # AI / ML
    (["machine_learning", "ai_", "_ai", "mlops", "artificial_intelligence",
      "deep_learning"],
     ["UODO-PL"]),  # RODO dotyczy AI przetwarzajacego dane osobowe
]
...
def build_mappings(conn: sqlite3.Connection, dry_run: bool = False):
    ...
    for doc_uid, path, title in docs:
        path = path or ""
        title = title or ""
...
def inject_standards_section(dry_run: bool = False, limit: int = 0):
    ...
    cur.execute("""
        ...
        GROUP BY m.doc_path
    """)
    std_map = {r[0]: list(zip(r[1].split(","), r[2].split(","))) if r[1] else []
    ...
    cur.execute("""
        ...
        GROUP BY m.doc_path
    """)
    reg_map = {r[0]: list(zip(r[1].split(","), r[2].split(","))) if r[1] else []
               for r in cur.fetchall()}
    conn.close()
    ...
    print(f"  Zmodyfikowano: {modified} plikow | Pominieto (brak mapowania lub juz ma sekcje): {skipped}")
    if dry_run:
