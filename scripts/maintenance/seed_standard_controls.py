...
ISO27001_CONTROLS = [
    ...
    ("ISO/IEC 27001", "A.5.2",  "Information security roles and responsibilities",                "Organizational", None),
    ...
    ("ISO/IEC 27001", "A.5.8",  "Information security in project management",                    "Organizational", None),
    ("ISO/IEC 27001", "A.5.9",  "Inventory of information and other associated assets",          "Organizational", None),
    ("ISO/IEC 27001", "A.5.10", "Acceptable use of information and other associated assets",     "Organizational", None),
    ...
    ("ISO/IEC 27001", "A.5.19", "Information security in supplier relationships",                "Organizational", None),
    ("ISO/IEC 27001", "A.5.20", "Addressing information security within supplier agreements",    "Organizational", None),
    ("ISO/IEC 27001", "A.5.21", "Managing information security in the ICT supply chain",         "Organizational", None),
    ("ISO/IEC 27001", "A.5.22", "Monitoring, review and change management of supplier services", "Organizational", None),
    ("ISO/IEC 27001", "A.5.23", "Information security for use of cloud services",                "Organizational", None),
    ("ISO/IEC 27001", "A.5.24", "Information security incident management planning and preparation", "Organizational", None),
    ("ISO/IEC 27001", "A.5.25", "Assessment and decision on information security events",        "Organizational", None),
    ("ISO/IEC 27001", "A.5.26", "Response to information security incidents",                   "Organizational", None),
    ("ISO/IEC 27001", "A.5.27", "Learning from information security incidents",                  "Organizational", None),
    ...
    ("ISO/IEC 27001", "A.5.31", "Legal, statutory, regulatory and contractual requirements",     "Organizational", None),
    ...
    ("ISO/IEC 27001", "A.5.34", "Privacy and protection of personally identifiable information", "Organizational", None),
    ("ISO/IEC 27001", "A.5.35", "Independent review of information security",                   "Organizational", None),
    ("ISO/IEC 27001", "A.5.36", "Compliance with policies, rules and standards for information security", "Organizational", None),
    ...
    ("ISO/IEC 27001", "A.6.3",  "Information security awareness, education and training",        "People", None),
    ("ISO/IEC 27001", "A.6.4",  "Disciplinary process",                                          "People", None),
    ("ISO/IEC 27001", "A.6.5",  "Responsibilities after termination or change of employment",    "People", None),
    ...
    ("ISO/IEC 27001", "A.7.5",  "Protecting against physical and environmental threats",         "Physical", None),
    ...
    ("ISO/IEC 27001", "A.8.14", "Redundancy of information processing facilities",               "Technological", None),
    ...
    ("ISO/IEC 27001", "A.8.19", "Installation of software on operational systems",               "Technological", None),
    ...
    ("ISO/IEC 27001", "A.8.27", "Secure system architecture and engineering principles",         "Technological", None),
    ("ISO/IEC 27001", "A.8.28", "Secure coding",                                                 "Technological", None),
    ("ISO/IEC 27001", "A.8.29", "Security testing in development and acceptance",                "Technological", None),
    ("ISO/IEC 27001", "A.8.30", "Outsourced development",                                        "Technological", None),
    ("ISO/IEC 27001", "A.8.31", "Separation of development, test and production environments",   "Technological", None),
    ("ISO/IEC 27001", "A.8.32", "Change management",                                             "Technological", None),
    ("ISO/IEC 27001", "A.8.33", "Test information",                                              "Technological", None),
    ("ISO/IEC 27001", "A.8.34", "Protection of information systems during audit testing",        "Technological", None),
]
...
NIST_CSF_CONTROLS = [
    ...
    # PROTECT
    ("NIST CSF 2.0", "PR.AA", "Identity Management, Authentication, and Access Control", "PROTECT", None),
...
def seed(db_path, apply=False, dry_run=False, standard=None):
    ...
    if apply:
        ...
        conn.rollback()
        print(f"[simulation] Would insert: {inserted}, Would skip: {skipped}  (use --apply to write)")
...
def main():
    ...
    parser.add_argument("--dry-run", dest="dry_run", action="store_true", help="Show counts only, no write")
