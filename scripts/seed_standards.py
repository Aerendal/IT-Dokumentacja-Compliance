...
INTERNATIONAL_STANDARDS = [
    ...
    ("ISO/IEC 27001", "System Zarządzania Bezpieczeństwem Informacji (ISMS)", "Information Security Management Systems", "2022",
     ...
     "IT,Finanse,Zdrowie,Administracja,Telekomunikacja", "https://www.iso.org/standard/27001"),
    ("ISO/IEC 27002", "Wytyczne Praktyk Bezpieczeństwa Informacji", "Information Security Controls", "2022",
     ...
     "IT,Finanse,Zdrowie,Administracja", "https://www.iso.org/standard/75652"),
    ("ISO/IEC 27005", "Zarządzanie Ryzykiem Bezpieczeństwa Informacji", "Information Security Risk Management", "2022",
     ...
     "IT,Finanse,Zdrowie", "https://www.iso.org/standard/80585"),
    ("ISO/IEC 27017", "Bezpieczeństwo w Chmurze Obliczeniowej", "Security for Cloud Services", "2015",
     ...
     "IT,Chmura", "https://www.iso.org/standard/43757"),
    ("ISO/IEC 27018", "Ochrona Danych Osobowych w Chmurze (PII)", "Protection of PII in Public Clouds", "2019",
     ...
     "IT,Chmura,Finanse", "https://www.iso.org/standard/76559"),
    ("ISO/IEC 27701", "Zarządzanie Informacjami o Prywatności (PIMS)", "Privacy Information Management", "2019",
     ...
     "IT,Finanse,Zdrowie,Administracja", "https://www.iso.org/standard/71670"),
    ("ISO/IEC 27035", "Zarządzanie Incydentami Bezpieczeństwa Informacji", "Information Security Incident Management", "2023",
     ...
     "IT,Finanse,Zdrowie", "https://www.iso.org/standard/74007"),
    # --- ISO/IEC: Jakosc oprogramowania ---
    ("ISO/IEC 25010", "Model Jakości Systemu i Oprogramowania (SQuaRE)", "System and Software Quality Models", "2023",
     ...
     "IT,Inzynieria oprogramowania", "https://www.iso.org/standard/78176"),
    ("ISO/IEC 25040", "Proces Oceny Jakości Produktu", "Evaluation Process", "2011",
     "Definiuje wymagania i wytyczne dla procesu oceny jakości produktu oprogramowania i systemów. Część serii SQuaRE.",
     "IT,QA", "https://www.iso.org/standard/35765"),
    # --- ISO/IEC: Inzynieria systemow i oprogramowania ---
    ("ISO/IEC 12207", "Procesy Cyklu Życia Oprogramowania", "Software Life Cycle Processes", "2017",
     ...
     "IT,Inzynieria oprogramowania", "https://www.iso.org/standard/63712"),
    ("ISO/IEC 15288", "Procesy Cyklu Życia Systemów", "System Life Cycle Processes", "2023",
     ...
     "IT,Systemy wbudowane,Obronnosc", "https://www.iso.org/standard/82426"),
    ("ISO/IEC 29110", "Profile Cyklu Życia dla Małych Jednostek", "Life Cycle Profiles for VSEs", "2016",
     ...
     "IT,MMP,Startupy", "https://www.iso.org/standard/62711"),
    ("ISO/IEC 42001", "System Zarządzania Sztuczną Inteligencją (AIMS)", "AI Management Systems", "2023",
     ...
     "IT,AI/ML,Finanse,Zdrowie", "https://www.iso.org/standard/81230"),
    # --- ISO: Jakosc i zarzadzanie ---
    ("ISO 9001", "System Zarządzania Jakością (QMS)", "Quality Management Systems", "2015",
     ...
     "Wszystkie branże", "https://www.iso.org/standard/62085"),
    ("ISO 20000-1", "System Zarządzania Usługami IT (SMS)", "IT Service Management", "2018",
     ...
     "IT,Telekomunikacja", "https://www.iso.org/standard/70636"),
    # --- IEEE ---
    ("IEEE 829", "Dokumentacja Testowania Oprogramowania i Systemów", "Software and System Test Documentation", "2008",
     ...
     "IT,QA,Inzynieria oprogramowania", "https://standards.ieee.org/ieee/829"),
    ("IEEE 830", "Zalecana Praktyka dla Specyfikacji Wymagań Oprogramowania (SRS)", "Recommended Practice for SRS", "1998",
     ...
     "IT,Inzynieria oprogramowania", "https://standards.ieee.org/ieee/830"),
    ("IEEE 1016", "Standard dla Opisów Projektowania Oprogramowania (SDD)", "Software Design Descriptions", "2009",
     ...
     "IT,Architektura", "https://standards.ieee.org/ieee/1016"),
    ("IEEE 1012", "Standard Weryfikacji i Walidacji Oprogramowania i Systemów", "System, Software, and Hardware V&V", "2016",
     ...
     "IT,QA,Systemy krytyczne", "https://standards.ieee.org/ieee/1012"),
    ("IEEE 42010", "Opis Architektoniczny Systemów i Oprogramowania", "Architecture Description", "2011",
     ...
     "IT,Architektura", "https://standards.ieee.org/ieee/42010"),
    # --- Frameworki IT ---
    ("ITIL 4", "Biblioteka Infrastruktury IT (Zarządzanie Usługami)", "IT Infrastructure Library v4", "2019",
     ...
     "IT,Telekomunikacja,Finanse", "https://www.axelos.com/certifications/itil-service-management"),
    ("TOGAF ADM", "Framework Architektury Korporacyjnej (The Open Group)", "The Open Group Architecture Framework", "10",
     ...
     "IT,Architektura,Finanse,Administracja", "https://www.opengroup.org/togaf"),
    ("PMBOK 7", "Przewodnik po Zarządzaniu Projektami (PMI)", "Project Management Body of Knowledge", "7",
     ...
     "Wszystkie branże", "https://www.pmi.org/pmbok-guide-standards/foundational/pmbok"),
    ("COBIT 2019", "Kontrola nad Informacją i Technologiami (ISACA)", "Control Objectives for Information and Related Technologies", "2019",
     ...
     "IT,Finanse,Administracja", "https://www.isaca.org/resources/cobit"),
    ("DORA", "Ustawa o Cyfrowej Odporności Operacyjnej (UE)", "Digital Operational Resilience Act", "2022",
     ...
     "Finanse,IT,Ubezpieczenia", "https://eur-lex.europa.eu/legal-content/PL/TXT/?uri=CELEX:32022R2554"),
    ("NIS2", "Dyrektywa w sprawie Bezpieczeństwa Sieci i Systemów Informacyjnych (UE)", "Network and Information Security Directive 2", "2022",
     ...
     "IT,Energia,Transport,Zdrowie,Finanse,Administracja", "https://eur-lex.europa.eu/legal-content/PL/TXT/?uri=CELEX:32022L2555"),
    ("SOC 2", "Kontrole Organizacji Usług (Typ I i II)", "Service Organization Controls 2", "2017",
     ...
     "IT,SaaS,Chmura,Finanse", "https://www.aicpa-cima.com/resources/landing/system-and-organization-controls-soc-suite-of-services"),
    ("CIS Controls v8", "Krytyczne Mechanizmy Bezpieczeństwa (CIS)", "CIS Critical Security Controls", "8",
     ...
     "IT,Finanse,Zdrowie,Administracja", "https://www.cisecurity.org/controls"),
    ("OWASP ASVS", "Standard Weryfikacji Bezpieczeństwa Aplikacji (OWASP)", "Application Security Verification Standard", "4.0.3",
     ...
     "IT,Aplikacje webowe,Finanse", "https://owasp.org/www-project-application-security-verification-standard"),
    ("OWASP MASVS", "Standard Weryfikacji Bezpieczeństwa Aplikacji Mobilnych (OWASP)", "Mobile Application Security Verification Standard", "2.0",
     ...
     "IT,Mobile", "https://mas.owasp.org/MASVS"),
    ("PCI DSS", "Standard Bezpieczeństwa Danych Przemysłu Kart Płatniczych", "Payment Card Industry Data Security Standard", "4.0",
     ...
     "Finanse,Handel,IT,E-commerce", "https://www.pcisecuritystandards.org/document_library"),
    ("HL7 FHIR", "Standard Wymiany Danych w Ochronie Zdrowia", "Fast Healthcare Interoperability Resources", "R4",
     ...
     "Zdrowie,IT medyczne", "https://hl7.org/fhir"),
    ("GDPR / RODO", "Ogólne Rozporządzenie o Ochronie Danych Osobowych (UE)", "General Data Protection Regulation", "2016",
     ...
     "Wszystkie branże", "https://eur-lex.europa.eu/legal-content/PL/TXT/?uri=CELEX:32016R0679"),
    ("NIST CSF", "Framework Cyberbezpieczeństwa NIST", "NIST Cybersecurity Framework", "2.0",
     ...
     "IT,Energia,Infrastruktura krytyczna", "https://www.nist.gov/cyberframework"),
    ("NIST SP 800-53", "Katalog Mechanizmów Bezpieczeństwa i Prywatności (NIST)", "Security and Privacy Controls for Systems", "Rev. 5",
     ...
     "IT,Administracja,Obronnosc", "https://csrc.nist.gov/publications/detail/sp/800-53/rev-5/final"),
    ("PRINCE2 7", "Projekty w Kontrolowanych Środowiskach", "Projects in Controlled Environments", "7",
     ...
     "Wszystkie branże", "https://www.axelos.com/certifications/propath/prince2-project-management"),
    ("SCRUM Guide", "Przewodnik Scrum", "The Scrum Guide", "2020",
     ...
     "IT,Wytwarzanie oprogramowania", "https://scrumguides.org"),
    ("SAFe 6.0", "Scaled Agile Framework", "Scaled Agile Framework", "6.0",
     ...
     "IT,Korporacje", "https://scaledagileframework.com"),
    ("ISO/IEC 38500", "Ład Informatyczny Organizacji", "Governance of IT for the Organization", "2015",
     ...
     "IT,Administracja,Finanse", "https://www.iso.org/standard/62816"),
    ("ISO 22301", "System Zarządzania Ciągłością Działania (BCMS)", "Business Continuity Management Systems", "2019",
     ...
     "Wszystkie branże", "https://www.iso.org/standard/75106"),
    ("ISO/IEC 20546", "Technologie Informacyjne — Big Data", "Big Data Overview and Vocabulary", "2019",
     "Przegląd i słownictwo big data. Definiuje terminy, koncepcje i taksonomię dla technologii big data.",
     "IT,Data Engineering,AI/ML", "https://www.iso.org/standard/38145"),
    ("ISO/IEC 23053", "Framework dla Systemów AI z Uczeniem Maszynowym", "Framework for AI Systems Using ML", "2022",
     "Opisuje framework dla systemów AI używających uczenia maszynowego. Definiuje komponenty, procesy i role w systemach ML.",
     "IT,AI/ML", "https://www.iso.org/standard/74438"),
    ("OpenAPI 3.x", "Specyfikacja Interfejsu API (OpenAPI Initiative)", "OpenAPI Specification", "3.1",
     ...
     "IT,Integracja,API", "https://spec.openapis.org/oas/latest.html"),
    ("AsyncAPI 3.x", "Specyfikacja Asynchronicznych API", "AsyncAPI Specification", "3.0",
     ...
     "IT,Integracja,Messaging", "https://www.asyncapi.com/docs/reference/specification/latest"),
]
...
POLISH_REGULATIONS = [
    ...
    ("KSC-PL", "Ustawa o Krajowym Systemie Cyberbezpieczeństwa",
     "Polska", "IT,Telekomunikacja,Energia,Transport,Zdrowie,Administracja,Finanse",
    ...
    ("PZP-PL", "Prawo Zamówień Publicznych",
     "Polska", "Administracja,IT,Budownictwo,Doradztwo",
    ...
    ("UŚUDE-PL", "Ustawa o Świadczeniu Usług Drogą Elektroniczną",
     "Polska", "IT,E-commerce,Media,Handel",
    ...
    ("PT-PL", "Prawo Telekomunikacyjne (Ustawa o komunikacji elektronicznej)",
     "Polska", "Telekomunikacja,IT,Media",
    ...
    ("UoR-PL", "Ustawa o Rachunkowości",
     "Polska", "Finanse,Handel,IT,Wszystkie branże",
    ...
    ("KSH-IT-PL", "Wymogi IT w Kodeksie Spółek Handlowych (KSH)",
     "Polska", "Finanse,Handel,IT",
    ...
    ("KEP-PL", "Ustawa o Kwalifikowanej Usłudze Zaufania (eIDAS/KEP)",
     "Polska", "IT,Administracja,Finanse,Prawo",
    ...
    ("SOLVENCY2-PL", "Solvency II — Wymogi IT dla Ubezpieczycieli (implementacja PL)",
     "Polska", "Ubezpieczenia,Finanse,IT",
    ...
    ("PN-ISO/IEC-27001", "PN-ISO/IEC 27001:2023-09 — Systemy Zarządzania Bezpieczeństwem Informacji",
     "Polska (PKN)", "IT,Finanse,Zdrowie,Administracja",
    ...
    ("PN-EN-ISO-IEC-20000-1", "PN-EN ISO/IEC 20000-1:2019 — Zarządzanie Usługami IT",
     ...
     "Brak odrębnych sankcji."),
    ("PN-ISO-IEC-25010", "PN-ISO/IEC 25010:2023 — Model Jakości Systemu i Oprogramowania",
     "Polska (PKN)", "IT,Inzynieria oprogramowania",
     ...
     "Brak odrębnych sankcji."),
    ("PN-EN-ISO-IEC-12207", "PN-EN ISO/IEC 12207:2017 — Procesy Cyklu Życia Oprogramowania",
     "Polska (PKN)", "IT,Inzynieria oprogramowania",
    ...
    ("CERT-PL-WYTYCZNE", "Wytyczne CERT Polska (CSIRT NASK) dot. cyberbezpieczeństwa",
     "Polska (CERT Polska / CSIRT NASK)", "IT,Telekomunikacja,Energia,Administracja",
    ...
    ("KNF-REKOM-IT", "Rekomendacje KNF dot. systemów IT w sektorze finansowym",
     "Polska (KNF)", "Finanse,Ubezpieczenia,IT finansowe",
    ...
    ("MC-INTEROP-PL", "Wytyczne Ministerstwa Cyfryzacji dot. interoperacyjności systemów publicznych",
     "Polska (Ministerstwo Cyfryzacji)", "Administracja,IT publiczne",
    ...
    ("CYBERSEC-STRATEGIA-PL", "Strategia Cyberbezpieczeństwa RP 2019-2024 (aktualizacja 2025+)",
     "Polska (Rząd RP)", "IT,Administracja,Infrastruktura krytyczna",
