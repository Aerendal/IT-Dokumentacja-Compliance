    ...
    for dt in DOCUMENT_TYPES:
        ...
        try:
            if "type_code" in cols and "name_pl" in cols and "name_en" in cols:
                ...
                for col, val in [("type_name", name_pl), ("type_description", desc),
                                  ("typical_owner", owner), ("typical_format", fmt),
                                  ("name", name_pl), ("description", desc)]:
