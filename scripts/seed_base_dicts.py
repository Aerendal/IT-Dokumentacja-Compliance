...
ROLES = [
    (
        ...
        "Product Owner",
        "Product Owner",
        "Właściciel produktu; odpowiada za backlog i priorytety",
    ),
    (
        "PM",
        "Project Manager",
        "Project Manager",
        "Kierownik projektu; planowanie, harmonogram, budżet",
    ),
    ...
    (
        ...
        "Architekt rozwiązań",
        "Solution Architect",
        "Projektuje rozwiązanie w kontekście biznesowym",
    ),
    (
        "EA",
        "Architekt korporacyjny",
        "Enterprise Architect",
        "Architektura całej organizacji (TOGAF)",
    ),
    ...
    (
        ...
        "Inżynier DevOps",
        "DevOps Engineer",
        "CI/CD, infrastruktura, automatyzacja wdrożeń",
    ),
    ...
    (
        ...
        "Administracja serwerami, sieciami, systemami",
    ),
    (
        "DBA",
        "Administrator baz danych",
        "Database Administrator",
        "Zarządzanie bazami danych, performance, backup",
    ),
    (
        "SEC",
        "Inżynier bezpieczeństwa",
        "Security Engineer",
        "Implementacja i utrzymanie zabezpieczeń",
    ),
    (
        "CISO",
        "CISO",
    ...
    (
        ...
        "Zgodność z RODO/GDPR, ochrona danych osobowych",
    ),
    ...
    (
        ...
        "Data Scientist",
        "Data Scientist",
        "Modele ML, analiza statystyczna, eksperymentowanie",
    ),
    (
        "MLOPS",
        "MLOps Engineer",
        "MLOps Engineer",
        "Wdrożenie i monitorowanie modeli ML na produkcji",
    ),
    ...
    (
        ...
        "Chief Product Officer",
        "Strategia produktowa całej organizacji",
    ),
    ...
    (
        ...
        "Architekt chmury",
        "Cloud Architect",
        "Projektowanie i optymalizacja infrastruktury chmurowej",
    ),
    ...
    (
        "PART",
        "Partner biznesowy IT",
        "IT Business Partner",
        "Łącznik między IT a jednostkami biznesowymi",
    ),
]
...
PHASES = [
    (
        ...
        "strategy",
        False,
        "Wizja, cele, wstępny zakres, studium wykonalności",
    ),
    (
        2,
        "Analiza Wymagań",
        ...
        "analysis",
        False,
        "Wymagania funkcjonalne i niefunkcjonalne, user stories",
    ),
    ...
    (
        ...
        "quality",
        True,
        "Testy jednostkowe, integracyjne, systemowe, UAT",
    ),
    (
        7,
        ...
        "security",
        False,
        "Testy bezpieczeństwa, audyt zgodności, certyfikacja",
    ),
    (
        8,
        ...
        "delivery",
        False,
        "Wdrożenie na produkcję, migracja danych",
    ),
    (
        9,
        ...
        "operations",
        True,
        "Eksploatacja, wsparcie, monitorowanie",
    ),
    (
        10,
        ...
        "operations",
        True,
        "Obsługa incydentów, eskalacje, SLA",
    ),
    (
        11,
        ...
        "operations",
        True,
        "Metryki, logi, alerty, dashboardy",
    ),
    (
        12,
        ...
        "operations",
        True,
        "Tuning, skalowanie, capacity planning",
    ),
    (
        13,
        ...
        "operations",
        True,
        "CMDB, IaC, zarządzanie konfiguracją",
    ),
    (
        14,
        "Komunikacja stakeholders",
        "Stakeholder Communication",
        "governance",
        True,
        "Raporty statusowe, spotkania przeglądowe",
    ),
    (
        15,
        ...
        "governance",
        True,
        "Dokumentacja, baza wiedzy, onboarding",
    ),
    (
        16,
        "Postmortem / Retrospektywa",
        "Postmortem / Retrospective",
        "governance",
        True,
        "Analiza incydentów, wyciąganie wniosków",
    ),
    (
        17,
        "Budżetowanie / Cost Mgmt",
        "Budgeting / Cost Management",
        "governance",
        False,
        "Planowanie budżetu, rozliczenia, FinOps",
    ),
    (
        18,
        "Vendor Management",
        ...
        "governance",
        True,
        "Zarządzanie dostawcami, kontrakty, SLA",
    ),
    (
        19,
        ...
        "governance",
        True,
        "Zarządzanie ładem IT, audyty, regulacje",
    ),
    (
        20,
        "Decommission / Sunset",
        ...
        "closure",
        False,
        "Wycofanie systemu, archiwizacja, migracja",
    ),
    (
        21,
        "DR / BCP",
        ...
        "resilience",
        False,
        "Plan ciągłości działania, odtwarzanie po awarii",
    ),
    (
        22,
        "Change Management",
        ...
        "governance",
        True,
        "Zarządzanie zmianami (ITIL Change Mgmt)",
    ),
    (
        23,
        "Capacity Planning",
        ...
        "operations",
        True,
        "Planowanie pojemności, prognozowanie wzrostu",
    ),
]
...
DOC_CATEGORIES = [
    ...
    (
        ...
        "Bezpieczeństwo",
        "Security",
        "Polityki, procedury i standardy bezpieczeństwa",
        "#E74C3C",
    ),
    (
        "ARCHITECTURE",
        "Architektura",
        "Architecture",
        "Decyzje, diagramy i dokumenty architektoniczne",
        "#3498DB",
    ),
    (
        "DEVELOPMENT",
        ...
        "Wymagania, specyfikacje, dokumenty deweloperskie",
        "#27AE60",
    ),
    (
        "QUALITY",
        "Jakość i testowanie",
        "Quality and Testing",
        "Plany testów, raporty jakości, strategie QA",
        "#F39C12",
    ),
    (
        "OPERATIONS",
        "Operacje IT",
        "IT Operations",
        "Runbooki, procedury operacyjne, monitoring",
        "#8E44AD",
    ),
    (
        "DATA",
        "Zarządzanie danymi",
        "Data Management",
        "Modele danych, katalogi, pipeline'y",
        "#16A085",
    ),
    (
        "COMPLIANCE",
        ...
        "Dokumenty audytowe, zgodności, regulacyjne",
        "#D35400",
    ),
    (
        "PROJECT",
        ...
        "Project Management",
        "Plany, harmonogramy, raporty statusowe",
        "#2980B9",
    ),
    (
        "INCIDENT",
        "Incydenty i eskalacje",
        "Incident Management",
        "Playbooki, runbooki incydentowe, postmortem",
        "#C0392B",
    ),
    (
        "CONTINUITY",
        "Ciągłość działania",
        "Business Continuity",
        "BCP, DRP, plany odtwarzania po awarii",
        "#1ABC9C",
    ),
    (
        "VENDOR",
    ...
    (
        ...
        "Zarządzanie wiedzą",
        "Knowledge Management",
        "Bazy wiedzy, onboarding, dokumentacja procesów",
        "#BDC3C7",
    ),
    (
        "INFRASTRUCTURE",
        "Infrastruktura",
        "Infrastructure",
        "Dokumenty infrastruktury, sieci, chmury",
        "#34495E",
    ),
    (
        "PRODUCT",
        "Produkt i UX",
        "Product and UX",
        "Dokumenty produktowe, user research, roadmapy",
        "#9B59B6",
    ),
]
...
REL_TYPES = [
    ...
    (
        ...
        "Relates to",
        True,
        "Luźne powiązanie tematyczne lub informacyjne",
    ),
    ...
    (
        ...
        "Supersedes",
        False,
        "Dokument A zastępuje dokument B (nowa wersja)",
    ),
    (
        "IMPLEMENTS",
        "Implementuje",
        "Implements",
        False,
        "Dokument A implementuje wymagania z dokumentu B",
    ),
    (
        "REFERENCES",
        "Odwołuje się do",
        "References",
        False,
        "Dokument A cytuje lub odwołuje się do B",
    ),
    (
        "DERIVED_FROM",
        "Pochodzi z",
        "Derived from",
        False,
        "Dokument A jest wyprowadzony z dokumentu B",
    ),
    (
        "PRECEDES",
        "Poprzedza",
        "Precedes",
        False,
        "Dokument A jest tworzony przed dokumentem B (fazowo)",
    ),
    ...
    (
        ...
        "Triggers",
        False,
        "Istnienie/zmiana dokumentu A inicjuje pracę nad B",
    ),
]
...
QUALITY_DIMS = [
    (
        ...
        "70%",
        "90%",
        "template_auditor.py, checklist_atomic.jsonl",
    ),
    (
        "ACCURACY",
        "Dokładność",
